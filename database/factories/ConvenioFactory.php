...
class ConvenioFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'valor_filme' => $this->faker->randomFloat(2, 0, 1000),
            'dias_retorno_eletivo' => $this->faker->numberBetween(1, 30),
            'dias_retorno_emergencia' => $this->faker->numberBetween(1, 30),
            'vencimento_contrato' => $this->faker->date,
            'tag_impressao_de_saia' => $this->faker->word,
            'plano_de_contas' => $this->faker->word,
            'alerta_ficha_atendimento' => $this->faker->sentence(3),
